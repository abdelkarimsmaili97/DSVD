...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        #default='../../data/full_experiment_real_data_processed/chrome_debian/full_graph/v1/graph_features'
        default='../../data/ggnn_input/chrome_debian/cfg_dfg/v1/graph_features'
    )
    ...
    dataset = create_dataset(
        train_file=base_dir + '/train_GGNNinput.json',
        valid_file=base_dir + '/valid_GGNNinput.json',
        test_file=base_dir + '/test_GGNNinput.json',
        batch_size=64,
